...
try {
    ...
    if($submit == "Simpan"){
        ...
        if(!empty($_FILES['gambar']['tmp_name'])){//cek apakah file gambar berisi inputan
            ...
            $pnykt->edit("UPDATE tbl_penyakit SET penyakit = '$penyakit', solusi = '$solusi', pencegahan = '$pencegahan', deskripsi = '$deskripsi', penyebab = '$penyebab' WHERE kd_penyakit = '$kd_penyakit' ");
                   // print_r("berhasil"); die();
                    header("location: ". $_POST['redirect_to']);
        }
    }
